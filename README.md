...
A production-ready backend microservice for storing chat histories generated by RAG (Retrieval-Augmented Generation) based chatbot systems. Built with Java 17, Spring Boot 3.2, and PostgreSQL.
